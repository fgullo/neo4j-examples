...
public class Examples{
    ...
    @Procedure(value = "org.neo4j.aidna.examples.hello")
    ...
    @Procedure(value = "org.neo4j.aidna.examples.densestSubgraph")
    ...
    public Stream<DensestSubgraphOutput> densestSubgraph() {
        ...
        */
        ...
        return Arrays.stream(new DensestSubgraphOutput[]{new DensestSubgraphOutput(densestSubgraphString, maxDensity)});
    }
    ...
    public static class DensestSubgraphOutput {
        ...
        public DensestSubgraphOutput(String densestSubgraph, double density) {
